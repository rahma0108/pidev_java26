...
public class EvenementService {
    ...
    public void delete(int id) {
        ...
        String deleteParticipationsQuery = "DELETE FROM participations WHERE evenement_id = ?";
        try {
            PreparedStatement psParts = connection.prepareStatement(deleteParticipationsQuery);
            psParts.setInt(1, id);
            psParts.executeUpdate();
        } catch (SQLException e) {
            System.err.println("Delete Event Participations error: " + e.getMessage());
        }
